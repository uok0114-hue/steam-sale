...
export default function RootLayout({
  ...
  return (
    <html lang="ko" className="h-full select-none">
      <body className="min-h-full bg-zinc-950 text-[var(--foreground)] flex flex-col items-center">
        {/* Desktop Container & Mobile Screen Simulation Wrapper */}
        <div className="w-full max-w-md min-h-screen bg-[var(--background)] shadow-2xl flex flex-col pb-20 border-x border-[var(--border)] relative transition-colors duration-200">
          {/* Header */}
          <header className="sticky top-0 z-40 bg-[var(--background)]/90 backdrop-blur-md border-b border-[var(--border)]/80 px-4 py-3 flex items-center justify-between transition-colors duration-200">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[9px] text-zinc-400 font-bold hidden xs:inline">실시간 작동</span>
              </div>
              <ThemeToggle />
            </div>
          </header>
          ...
          <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-[var(--background)]/95 backdrop-blur-md border-t border-[var(--border)]/80 h-16 flex items-center justify-around px-2 z-50 transition-colors duration-200">
            <Link href="/" className="flex flex-col items-center justify-center w-16 h-full text-zinc-450 dark:text-zinc-400 hover:text-violet-500 dark:hover:text-violet-400 transition-colors">
            ...
            <Link href="/wishlist" className="flex flex-col items-center justify-center w-16 h-full text-zinc-450 dark:text-zinc-400 hover:text-violet-500 dark:hover:text-violet-400 transition-colors">
