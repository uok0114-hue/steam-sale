  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="text-[10px] bg-zinc-800 border border-zinc-700/60 rounded px-2 py-0.5 text-zinc-400 font-bold">
      ...
      <div className="flex flex-col gap-3">
        {loading ? (
          ...
          items.map((item) => {
            ...
            return (
              <div key={item.id} className="glass-panel rounded-2xl p-3 border border-zinc-800 flex flex-col gap-3">
                <div className="flex gap-3">
                  {/* Game Thumbnail */}
                  <div className="w-16 h-20 rounded-lg overflow-hidden flex-shrink-0 bg-zinc-800">
                    <img 
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      <h3 className="font-extrabold text-xs text-zinc-100 line-clamp-1">{game.title}</h3>
                      ...
                      <div className="flex flex-col gap-1 mt-1.5">
                        ...
                        <div className="flex justify-between items-center text-[9px]">
                          ...
                          <span className="text-zinc-400 font-semibold truncate max-w-[150px]">
